...
public abstract class HeapAbstractionFactory {
     ...
     * Memoization
     **********/
    private static final ConcurrentHashMap<Wrapper<InstanceKey>, InstanceKey> instanceKeymemo = MultiThreadAnalysisUtil
                                    .createConcurrentHashMap();
    private static final ConcurrentHashMap<Wrapper<Context>, Context> contextMemo = MultiThreadAnalysisUtil
                                    .createConcurrentHashMap();

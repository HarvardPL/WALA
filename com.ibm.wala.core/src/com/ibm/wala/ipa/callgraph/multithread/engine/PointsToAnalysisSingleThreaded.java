...
import com.ibm.wala.ipa.callgraph.multithread.registrar.StatementRegistrar.StatementListener;
import com.ibm.wala.ipa.callgraph.multithread.statements.ArrayToLocalStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.CallStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.ClassInitStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.ExceptionAssignmentStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.FieldToLocalStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.LocalToArrayStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.LocalToFieldStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.LocalToLocalStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.LocalToStaticFieldStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.NewStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.PhiStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.PointsToStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.ReturnStatement;
import com.ibm.wala.ipa.callgraph.multithread.statements.StaticFieldToLocalStatement;
import com.ibm.wala.ipa.callgraph.multithread.util.MultiThreadAnalysisUtil;
import com.ibm.wala.ipa.callgraph.multithread.util.Histogram;
...
public class PointsToAnalysisSingleThreaded extends PointsToAnalysis {
    ...
    public PointsToGraph solveAndRegister(StatementRegistrar onlineRegistrar) {
        onlineRegistrar.registerMethod(MultiThreadAnalysisUtil.getFakeRoot());
    ...
    public PointsToGraph solveSmarter(final StatementRegistrar registrar, final boolean registerOnline) {
        ...
        DependencyRecorder depRecorder = new DependencyRecorder() {
            ...
            private void updateLineCounter(IMethod m) {
                if (printed.add(m)) {
                    if (!m.isNative() && m instanceof IBytecodeMethod) {

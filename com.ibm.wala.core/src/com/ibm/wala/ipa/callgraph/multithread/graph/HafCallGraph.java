...
public class HafCallGraph extends ExplicitCallGraph {
     ...
     */
    public HafCallGraph(HeapAbstractionFactory haf, IClassHierarchy cha, AnalysisOptions options, AnalysisCache cache) {
        super(cha, options, cache);
        this.haf = haf;
        this.fakeRoot = MultiThreadAnalysisUtil.getFakeRoot();
        try {

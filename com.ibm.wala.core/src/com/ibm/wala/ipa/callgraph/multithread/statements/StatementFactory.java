...
public class StatementFactory {
  ...
  public NewStatement newForStringField(ReferenceVariable local, IMethod m) {
    return newForGeneratedObject(local, MultiThreadAnalysisUtil.getStringValueClass(), m, STRING_LIT_FIELD_DESC);
  }
  ...
  public NewStatement newForStringLiteral(String literalValue, ReferenceVariable local, IMethod m) {
    ...
    NewStatement s = new NewStatement(literalValue, local, MultiThreadAnalysisUtil.getStringClass(), m, true);

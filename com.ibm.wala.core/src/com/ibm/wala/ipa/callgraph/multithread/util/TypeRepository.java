...
public class TypeRepository {
     ...
     */
    private static final Map<OrderedPair<IClass, IClass>, Boolean> isAssignable = MultiThreadAnalysisUtil
    ...
    public static void print(IMethod m) {
        TypeInference ti = TypeInference.make(MultiThreadAnalysisUtil.getIR(m), true);
    ...
    public static boolean isAssignableFrom(IClass supertype, IClass subtype) {
        ...
        if (res == null) {
            res = MultiThreadAnalysisUtil.getClassHierarchy().isAssignableFrom(supertype, subtype);

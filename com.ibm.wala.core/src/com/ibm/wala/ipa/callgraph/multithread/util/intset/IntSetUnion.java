package com.ibm.wala.ipa.callgraph.multithread.util.intset;

import java.util.NoSuchElementException;

import com.ibm.wala.ipa.callgraph.multithread.graph.AbstractIntSet;
...
public class IntSetUnion extends AbstractIntSet {
    ...
    public static class SortedIntSetUnionIterator implements IntIterator {
        final IntIterator a;
        final IntIterator b;
        int aNext = -1;
        int bNext = -1;
        ...
        public SortedIntSetUnionIterator(IntIterator a, IntIterator b) {
            this.a = a;
            this.b = b;
        }
